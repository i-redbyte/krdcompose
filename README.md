...
- **[LightningBackground](specification/components/lightning.md)** - компонент для создания
  ...
  интереса.
- **[PlanetCard](specification/components/planetCard.md)** - компонент для отображения карточек
  планет
  в космическом стиле с поддержкой кастомных градиентов, анимаций и декоративных эффектов.
